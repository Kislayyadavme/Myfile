"""
message_fetcher.py (Improved Logging + GitHub Sync + StringSession Support)
"""
...
SESSION_STRING = os.getenv("SESSION_STRING", "")  # Stored in GitHub Secrets

if not SESSION_STRING:
    raise ValueError("❌ SESSION_STRING not found in GitHub Secrets!")

# Main user client (your account)
user_client = TelegramClient(StringSession(SESSION_STRING), API_ID, API_HASH)

# Bot client (control panel)
